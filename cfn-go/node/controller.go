...
func NewController(node *CFNNode) *Controller {
	core := &Controller{
		node: node,
	}
...
func (core *Controller) Start(host string, port int, name string) {
	// 启动远程
...
func (core *Controller) GetPID() *actor.PID {
	return core.pid
}

func (core *Controller) Receive(context actor.Context) {
...
func (core *Controller) initBehavior(context actor.Context) {
...
func (core *Controller) runningBehavior(context actor.Context) {
	logger := context.Logger()
	switch msg := context.Message().(type) {
	case *messages.Echo:
...
func (core *Controller) initHandler(context actor.Context) {
	// 获取当前结点的 pid
...
func (core *Controller) echoHandler(msg *messages.Echo, context actor.Context) {
...
func (core *Controller) unexpectedMessageHandler(msg interface{}, logger *slog.Logger) {
