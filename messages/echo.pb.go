...
const file_echo_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"echo.proto\x12\fcfn.messages\x1aVgithub.com/asynkron/protoactor-go@v0.0.0-20240822202345-3c0e61ca19c9/actor/actor.proto\"D\n" +
	"\x04Echo\x12\"\n" +
	"\x06Sender\x18\x01 \x01(\v2\n" +
	".actor.PIDR\x06Sender\x12\x18\n" +
	"\aMessage\x18\x02 \x01(\tR\aMessageB\x1fZ\x1dgithub.com/kekwy/cfn/messagesb\x06proto3"
...
var file_echo_proto_goTypes = []any{
	(*Echo)(nil),      // 0: cfn.messages.Echo
	(*actor.PID)(nil), // 1: actor.PID
}
var file_echo_proto_depIdxs = []int32{
	1, // 0: cfn.messages.Echo.Sender:type_name -> actor.PID
