...
const file_text_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"text.proto\x12\fcfn.messages\"\x1a\n" +
	"\x04Text\x12\x12\n" +
	"\x04Text\x18\x01 \x01(\tR\x04TextB\x1fZ\x1dgithub.com/kekwy/cfn/messagesb\x06proto3"
...
var file_text_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_text_proto_goTypes = []any{
	(*Text)(nil), // 0: cfn.messages.Text
}
