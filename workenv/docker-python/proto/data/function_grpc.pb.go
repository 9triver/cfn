...
const (
	FunctionService_DeployPyFunc_FullMethodName = "/data.FunctionService/deployPyFunc"
)
...
type FunctionServiceClient interface {
	DeployPyFunc(ctx context.Context, in *AppendPyFunc, opts ...grpc.CallOption) (*proto.ServiceReplay, error)
}
...
func (c *functionServiceClient) DeployPyFunc(ctx context.Context, in *AppendPyFunc, opts ...grpc.CallOption) (*proto.ServiceReplay, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(proto.ServiceReplay)
	err := c.cc.Invoke(ctx, FunctionService_DeployPyFunc_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FunctionServiceServer interface {
	DeployPyFunc(context.Context, *AppendPyFunc) (*proto.ServiceReplay, error)
...
func (UnimplementedFunctionServiceServer) DeployPyFunc(context.Context, *AppendPyFunc) (*proto.ServiceReplay, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeployPyFunc not implemented")
}
...
func _FunctionService_DeployPyFunc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AppendPyFunc)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FunctionServiceServer).DeployPyFunc(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FunctionService_DeployPyFunc_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FunctionServiceServer).DeployPyFunc(ctx, req.(*AppendPyFunc))
	}
...
var FunctionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "data.FunctionService",
	HandlerType: (*FunctionServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "deployPyFunc",
			Handler:    _FunctionService_DeployPyFunc_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "data/function.proto",
}
